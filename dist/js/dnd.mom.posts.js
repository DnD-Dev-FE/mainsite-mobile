...
var Swiper = function (selector, params) {
    ...
    function onTouchMove(event) {
        ...
        if (!isTouchEvent || event.touches.length === 1) {
            ...
            var _start = _this.positions.start; //added by ukhome@gmail.com
            ...
            //edit by ukhome@gmail.com
            //if (params.onTouchMove) _this.fireCallback(params.onTouchMove, _this, event, _start, _this.positions.current);
            if (params.onTouchMove) _this.fireCallback(params.onTouchMove, _this, event, ( _start - _this.positions.current) );
