<?php
    ...
    for ( $i=0; $i < 5; $i++ ) {
        $response .= '
            <li>
                <p><a href="posts.html#!news"><strong class="posts__cate">7. ' . ( $i%2 == 0 ? 'Sự kiện' : 'Tin tức' ) . '</strong></a>&nbsp;|&nbsp;<time class="posts__time">34 phút trước</time></p>
                <a href="post-details.html" title="">
                    <h3>Page 7: Cập nhật phiên bản mới</h3>' .
