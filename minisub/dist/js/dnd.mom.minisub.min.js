...
for(c=0;g>c;c++)d=a[c].split("="),(b=B[d.shift()])&&(f=b(f,d));for(c=0;e>c;c++)f=z[c](f);return f}function g(a,e,f,g,h){var i=b(a),j=i.autoCallback;i.url.split(".").pop().split("?").shift(),i.bypass||(e&&(e=d(e)?e:e[a]||e[g]||e[a.split("/").pop().split("?")[0]]),i.instead?i.instead(a,e,f,g,h):(A[i.url]?i.noexec=!0:A[i.url]=1,f.load(i.url,i.forceCSS||!i.forceJS&&"css"==i.url.split(".").pop().split("?").shift()?"c":c,i.noexec,i.attrs,i.timeout),(d(e)||d(j))&&f.load(function(){k(),e&&e(i.origUrl,h,g),j&&j(i.origUrl,h,g),A[i.url]=2})))}function h(a,b){function c(a,c){if(a){if(e(a))c||(l=function(){var a=[].slice.call(arguments);m.apply(this,a),n()}),g(a,l,b,0,j);else if(Object(a)===a)for(i in h=function(){var b,c=0;for(b in a)a.hasOwnProperty(b)&&c++;return c}(),a)a.hasOwnProperty(i)&&(!c&&!--h&&(d(l)?l=function(){var a=[].slice.call(arguments);m.apply(this,a),n()}:l[i]=function(a){return function(){var b=[].slice.call(arguments);a&&a.apply(this,b),n()}}(m[i])),g(a[i],l,b,i,j))}else!c&&n()}var h,i,j=!!a.test,k=a.load||a.both,l=a.callback||f,m=l,n=a.complete||f;c(j?a.yep:a.nope,!!k),k&&c(k)}var i,j,l=this.yepnope.loader;if(e(a))g(a,0,l,0);else if(y(a))for(i=0;i<a.length;i++)j=a[i],e(j)?g(j,0,l,0):y(j)?m(j):Object(j)===j&&h(j,l);else Object(a)===a&&h(a,l)},m.addPrefix=function(a,b){B[a]=b},m.addFilter=function(a){z.push(a)},m.errorTimeout=1e4,null==b.readyState&&b.addEventListener&&(b.readyState="loading",b.addEventListener("DOMContentLoaded",l=function(){b.removeEventListener("DOMContentLoaded",l,0),b.readyState="complete"},0)),a.yepnope=k(),a.yepnope.executeStack=h,a.yepnope.injectJs=function(a,c,d,e,i,j){var k,l,n=b.createElement("script"),e=e||m.errorTimeout;n.src=a;for(l in d)n.setAttribute(l,d[l]);c=j?h:c||f,n.onreadystatechange=n.onload=function(){!k&&g(n.readyState)&&(k=1,c(),n.onload=n.onreadystatechange=null)},o(function(){k||(k=1,c(1))},e),i?n.onload():p.parentNode.insertBefore(n,p)},a.yepnope.injectCss=function(a,c,d,e,g,i){var j,e=b.createElement("link"),c=i?h:c||f;e.href=a,e.rel="stylesheet",e.type="text/css";for(j in d)e.setAttribute(j,d[j]);g||(p.parentNode.insertBefore(e,p),o(c,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))};var Pattern={};Pattern.Mediator=function(){var a={},b=function(b,c){return a[b]||(a[b]=[]),a[b].push({context:this,callback:c}),this},c=function(b){if(!a[b])return!1;for(var c=Array.prototype.slice.call(arguments,1),d=0,e=a[b].length;e>d;d++){var f=a[b][d];f.callback.apply(f.context,c)}return this};return{pub:c,sub:b,installTo:function(a){a.pub=c,a.sub=b}}}(),jQuery.fn.activeMenu=function(a){function b(a,b){for(var c=(a.length,b.length,0),d=a.length>b.length?b.length:a.length,e=a.length<b.length?b.length:a.length,f=0;d>f;f++)a[f]==b[f]&&c++;var g=c/e;return 100*g+"%"}function c(a){var b=a.split("?"),c=b[0].split("/");h.each(function(){for(var a=$(this),b=a.attr("href"),e=0;e<c.length;e++)if("app_dev.php"==c[e]||""==c[e]);else if(b.search(c[e])>0||b.search(c[e])>0)return a.addClass(d),!1})}var d="Active";a.length>0&&(d=a);var e=this,f="//"+window.location.hostname+window.location.pathname,g=f;("/"==window.location.pathname||"/app_dev.php/"==window.location.pathname)&&(g=f+"index.html"),(""==window.location.pathname||"/app_dev.php"==window.location.pathname)&&(g=f+"/index.html"),f=g;var h=e.find("a"),i=0,j=!1;return h.each(function(){var a=$(this),c=parseFloat(b(a.attr("href"),f));c>i&&(i=c,j=a)}),i>=90?j.addClass(d):c(window.location.pathname),this},$("#main-nav__list").length&&$("#main-nav__list").activeMenu("active");var DnDMoM={};jQuery(document).ready(function(){!function(a){a(window),a("body");DnDMoM.initMainNav(),DnDMoM.initTopButton(),DnDMoM.initMinisubHeaderBar()}(jQuery)}),DnDMoM=function(a){var b=a(window);return{initMainNav:function(){var c=a("#drawer-toggle"),d=a("#main-nav"),e=(a(".main-nav__wrapper").eq(0),a("#main-nav__list")),f=Modernizr.touch?"touchend":"click";e.on(f," > li > ul a",function(a){a.stopPropagation()}).on(f," > li > a.main-nav__has-sub",function(){return a("#main-nav__list > li > a.main-nav__has-sub.focus").not(this).removeClass("focus"),a(this).toggleClass("focus"),!1}),a(document).on(f,function(){a("#main-nav__list > li > a.main-nav__has-sub.focus").removeClass("focus")}),d.on(f,function(a){a.stopPropagation()});var g=function(){Modernizr.mq("only screen and (max-width: 666px), (min-width: 667px) and (max-width: 1024px)")&&c.on("change",function(){a(this).is(":checked")?d.addClass("shown"):setTimeout(function(){d.removeClass("shown")},250)})};return a(window).on("resize",g),g(),Modernizr.mq("only screen and (max-width: 666px), (min-width: 667px) and (max-width: 1024px)")&&a(window).swipeListener({minX:25,minY:0,swipeRight:function(a){a.coords.start.x<=.25*b.width()&&Math.abs(a.coords.start.y-a.coords.stop.y)<=20&&(c.prop("checked","checked"),d.addClass("shown"))},swipeLeft:function(a){Math.abs(a.coords.start.y-a.coords.stop.y)<=20&&(c.prop("checked",!1),setTimeout(function(){d.removeClass("shown")},250))},swipeUp:function(){return!0},swipeDown:function(){return!0}}),e},initTopButton:function(){var c=a("#top-button"),d=.5*a(document).height(),e=function(){b.scrollTop()>=d?c.hasClass("flyout-content__top-button--shown")||c.addClass("flyout-content__top-button--shown"):c.removeClass("flyout-content__top-button--shown")};b.on("scroll",function(){e()}),e();var f=Modernizr.touch?"touchstart":"click";c.on(f,function(){return a("body, html").stop(!0,!0).animate({scrollTop:0}),!1})},initMinisubHeaderBar:function(){var c=a("#main-nav"),d=a("#topbar").outerHeight(!0)+a("#primary-banner").outerHeight(!0),e=function(){var e=!1;if(b.scrollTop()>=d){e=!0;var f=b.height();Modernizr.mq("only screen and (min-width: 1025px)")&&c.height()>f&&c.css("height",f-230)}else Modernizr.mq("only screen and (min-width: 1025px)")&&c.css("height","auto");a("#outer").toggleClass("minisub-header-stick",e)};b.on("scroll",e),e()}}}(jQuery),Pattern.Mediator.installTo(DnDMoM);